...
#ifndef _AUDIOSINK_CALLBACK_H_
#define _AUDIOSINK_CALLBACK_H_
...
class RTAudioSink : public IRTAudioSinkCallback {
public:
    RTAudioSink(android::MediaPlayerInterface *player);
    virtual ~RTAudioSink();
